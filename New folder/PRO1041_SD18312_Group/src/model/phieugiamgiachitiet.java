...
public class phieugiamgiachitiet {
    ...
    public phieugiamgiachitiet(Integer idGG, Integer maGiamGia, String tenGiamGia, Integer giaTriGiam, Integer idLG, String loaiGiam, String thoiGianKT, Integer soLuong) {
        this.idGG = idGG;
